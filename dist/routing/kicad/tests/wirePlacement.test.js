...
const state = { wires: [], junctions: [], pins: [], tolerance: 0.5 };
kernel.setState(state);
// Preview: begin at (0,0), update to (10,10) with HV should produce [A, (10,0), (10,10)]
...
//# sourceMappingURL=wirePlacement.test.js.map